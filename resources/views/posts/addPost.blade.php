        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <form class="form-horizontal" method="POST" action="{{ route('new-post')}}" enctype="multipart/form-data">
                  ...
                  <textarea id="post_body" rows="7" type="post_body" class="form-control" name="post_body"
                            ...
                            <div class="form-group{{ $errors->has('post_file') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="post_file" accept="file/*">
                            ...
                            <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="amount" type="number" min="1" class="form-control" name="amount" value="{{ old('amount') }}"
                                          >
